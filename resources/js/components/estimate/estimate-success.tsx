...
export default function EstimateSuccess({ message }: EstimateSuccessProps) {
    ...
    return (
        /* Same card surface as the rest of the site (contact, recap, blog): sand hairline, inner sand gradient — no dashed frame (user decision 2026-09-16). */
        <div role="status" className="border-secondary-30 bg-card mx-auto w-full max-w-3xl border p-2">
            <div className="from-background-05 flex flex-col items-center gap-10 bg-linear-to-b to-transparent px-4 py-10 text-center sm:p-12">
                ...
                <div className="flex w-full flex-col gap-2">
                    {advisor && (
                        <section
                            ...
                            className="bg-background-08 border-secondary-30 flex flex-col gap-1 border p-1.5"
                        >
                    ...
                    <section aria-labelledby="estimate-steps-title" className="bg-background-08 border-secondary-30 border p-4 sm:p-5">
