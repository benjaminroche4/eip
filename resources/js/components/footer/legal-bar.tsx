...
export default function LegalBar({ year }: { year: number }) {
    ...
    return (
        <div className="before:via-border relative flex flex-col items-start justify-between gap-4 py-6 text-sm before:pointer-events-none before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:to-transparent sm:flex-row sm:items-center sm:py-6">
