 ...
 * button (border only, `bg-card` white fill on the sand strip, decision 2026-09-21) on the right, the advisor's avatar on the left inside it instead of an icon (ui.sh option « Bande sable », decision 2026-08-27).
 */
export default function FaqCta({ title, button }: FaqCtaProps) {
    ...
    return (
        <div className="bg-background-08 flex flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Button asChild variant="outline" className="bg-card shrink-0 self-start pl-1.5 sm:self-auto">
