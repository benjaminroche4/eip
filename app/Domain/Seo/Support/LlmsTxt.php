...
final class LlmsTxt
{
    public function build(): string
    {
        ...
        $lines = [
            ...
            '- [À propos]('.url('/a-propos').') : l\'agence, sa méthode, son conseiller dédié et son adresse à Paris 6e.',
            '- [Arrondissements de Paris]('.url('/arrondissements-paris').') : carte interactive des 20 arrondissements, quartiers, profil idéal et prix moyen au m² (Notaires du Grand Paris).',
            ...
            '- [About us]('.url('/en/about-us').') : the agency, its method, its dedicated advisor and its address in Paris 6th.',
            '- [Paris arrondissements]('.url('/en/paris-districts').') : interactive map of the 20 arrondissements, districts, best-fit profile and average price per m² (Notaires du Grand Paris).',
